...
function hj(){var b,a;gj();var c,d;for(d=(b=co(new bo(),mq(lj.a).b.a),Cp(new Bp(),b));d.a.u();){c=Fd((a=d.a.x(),a.q()),5);if(c.v()){c.A()}}}
...
function Fp(){return this.a.u()}
function aq(){var a;return a=this.a.x(),a.q()}
function Bp(){}
