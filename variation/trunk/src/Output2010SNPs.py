...
Examples:
	Output2010SNPs.py -o /tmp/phenotype.tsv
...
def _run_():
	...
	long_options_list = ["hostname=", "user=", "passwd=", "version=", "delim=", "missingval=", "accname", "debug", "report", "help"]
	try:
	...
	import dataParsers
	snpsds = dataParsers.get2010DataFromDb(host=hostname,chromosomes=[1,2,3,4,5], dataVersion=version, user=user, passwd=passwd)
