...
Examples:
	...
	QC.py -i /mnt/nfs/NPUTE_data/input/250K_m3_70_n1000.csv -j /mnt/nfs/NPUTE_data/input/2010_149_384.csv -l 2 -o /tmp/250K_m3_70_n1000_vs_2010_149_384.QC.tsv -b
	
	#compare 250k (output by Output250KSNPs.py) and 384-illumina (output by dbSNP2data.py)
	QC.py -i /mnt/nfs/NPUTE_data/input/250K_m3_70.csv -j /home/crocea/script/variation/genotyping/384-illumina_y0000111111.csv -k 2 -l 2 -o /tmp/250K_m3_70_vs_384-illumina.QC.tsv
	
	#compare 250k (output by DB_250k2data.py) with 2010 (output by Output2010InCertainSNPs.py)
	QC.py -i /mnt/nfs/NPUTE_data/250k_l3_y0.85_v0.6_w0.2_x0.2.tsv -j data/2010/data_2010_x_250k.tsv -o /mnt/nfs/NPUTE_data/QC_output/250k_l3_y0.85_v0.6_w0.2_x0.2_vs_2010_x_250k.QC.tsv
...
class QC(object):
	...
	option_default_dict = {('input_fname1',1, ): [None, 'i', 1, 'File containing the calls'],\
							...
							('input_fname1_format',1,int): [1, 'k', 1, 'Format of input_fname1. 1=strain X snp (Yu). 2=snp X strain (Bjarni).'],\
							('input_fname2_format',1,int): [1, 'l', 1, 'Format of input_fname2. 1=strain X snp (Yu). 2=snp X strain (Bjarni).'],\
	...
	def run(self):
		...
		if self.input_fname2_format != self.input_fname2_format:
		...
		if self.input_fname2_format != self.input_fname2_format:	#if different type, transpose the 2nd snpData
		...
		elif self.input_fname1_format == 2:	#col_id for the 1st file = (array_id, accession). for 2nd file, col_id=accession.
