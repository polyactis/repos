...
create table call_info(
	...
	array_id integer,
	NA_rate float,
	no_of_mismatches_2010 integer,
	no_of_non_NA_pairs_2010 integer,
	no_of_mismatches_149SNP integer,
	no_of_non_NA_pairs_149SNP integer,
	no_of_mismatches_perlegen integer,
	no_of_non_NA_pairs_perlegen integer,
	created_by varchar(200),
	updated_by varchar(200),
	date_created timestamp default CURRENT_TIMESTAMP,
	date_updated TIMESTAMP,
