...
Option:
	...
	--addConstant=...		Adds the given value to the phenotypic values (before log-transforming)
...
def _run_():
	...
	long_options_list = ["rFile=","chr=", "delim=", "missingval=", "withArrayId=", "BoundaryStart=", "removeOutliers=", "addConstant=", "logTransform", "BoundaryEnd=", "phenotypeFileType=", "help", "parallel=", "parallelAll", "LRT", "minMAF=", "kinshipDatafile="]
	try:
	...
	parallelAll = False
	lrt = False
	kinshipDatafile = None #"/home/cmb-01/bvilhjal/Projects/data/250K_f11_100708.csv"  #This default path should perhaps be something else..
...
"""
	...
	if chr:
		print "Removing SNPs which are outside of boundaries"
