...
//////////////////////////////////////////////////////////// glob variable
int noPar=11;
int nGlob=100;	//2009-3-26 number of individuals
int no_of_PCs = 8;	//2009-3-26 default is 8. hard-coded below
int M=4;
...
int main()
{
	...
	for (nr=1;nr<=N_gene;nr++){
		...
		for (chain=1; chain<=chain_N; chain++){
			...
			so=initValu[noPar];	//2009-3-26 variance?
