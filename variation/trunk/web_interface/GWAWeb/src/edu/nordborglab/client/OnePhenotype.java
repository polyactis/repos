...
public class OnePhenotype implements EntryPoint {
	...
	private CustomVerticalPanel rPanel;
	...
	public void onModuleLoad() {
		...
		rPanel = new CustomVerticalPanel(constants, jsonErrorDialog, constants.OnePhenotypeHelpID());
		rootPanel.add(rPanel);
		...
		phenotypeHistPanel = new DisclosurePanel("Histogram");
		...
		rPanel.add(phenotypeHistPanel);

		hPanel = new HorizontalPanel();
		hPanelDisclosurePanel = new DisclosurePanel("Static Histograms & QQ Plots");
		hPanelDisclosurePanel.setAnimationEnabled(true);
		hPanelDisclosurePanel.setContent(hPanel);
		//hPanelDisclosurePanel.setOpen(true);
		rPanel.add(hPanelDisclosurePanel);

		motionChart = new MotionChart();
		motionChart.setSize("1000px", "800px");	 	//doesn't work. have to be set in the options before draw()
		motionChartDisclosurePanel = new DisclosurePanel("MotionChart");
		//motionChartDisclosurePanel.setHeader(new HTML("<a>MotionChart</a>"));
		...
		rPanel.add(motionChartDisclosurePanel);
