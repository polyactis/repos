...
from Variation.SNP250k import config
...
VariationMessageFactory = MessageFactory(config.PROJECTNAME)
...
#setDefaultRoles(config.MAKE_RESERVATION_PERMISSION, ('Member', 'Manager',))
...
def initialize(context):
	...
	from content import phenotype, variationfolder
