...
film and cinema view pages.
    ...
    >>> class DummyScreeningLocator(object):
    ...
    ...         return self._films_at_cinema
    ...         
    ...     def cinemas_for_film(self, film, from_date, to_date):
    ...         return self._cinemas_for_film
    ...     
...
We need to remember the existing utility so that we can set it back at the
    ...
    >>> _old_screening_locator = getUtility(IScreeningLocator)
    >>> provideUtility(DummyScreeningLocator())
