...
CinemaSchema['title'].storage = atapi.AnnotationStorage()
CinemaSchema['title'].widget.label = _(u"Cinema name")
CinemaSchema['title'].widget.description = _(u"")

CinemaSchema['description'].storage = atapi.AnnotationStorage()
