...
class IMyCinemaPortlet(IPortletDataProvider):
    pass
...
class Renderer(base.Renderer):
    ...
    render = ViewPageTemplateFile('mycinema.pt')
    ...
    @property
    def available(self):
        return len(self._cinema_codes()) > 0

    
    def cinemas(self):
        context = aq_inner(self.context)
        cinema_codes = self._cinema_codes()
