...
protected:
	 ...
	 */
	bool Open(bool bReadHeaderOnly=false, bool bReadProbeSetNamesOnly=false);
	 ...
	 * @return True if successful.
	 */
	bool ReadXDAFormat(bool bReadHeaderOnly, bool bReadProbeSetNamesOnly=false);
	 ...
	 * @return True if successful.
	 */
	bool ReadXDAFormatUsingMemMap(bool bReadHeaderOnly, bool bReadProbeSetNamesOnly=false);
...
public:
	...
	/*! Reads the header and the probe set names of the file only.
	 * @return True if successful.
	 */
	bool ReadProbeSetNames();
