...
#include "FileIO.h"
/* IS_BIG_ENDIAN is defined in FileIO.h */
#ifdef IS_BIG_ENDIAN
#warning "using Big-endian definitions"
#else
#warning "using little-endian definitions"
#endif
