...
//
////////////////////////////////////////////////////////////////
#include "CHPQuantificationDetectionDataTest.h"
#include "CHPQuantificationDetectionData.h"

using namespace std;
using namespace affymetrix_calvin_io;

CPPUNIT_TEST_SUITE_REGISTRATION( CHPQuantificationDetectionDataTest );

void CHPQuantificationDetectionDataTest::setUp()
{
}

void CHPQuantificationDetectionDataTest::tearDown()
{
}

void CHPQuantificationDetectionDataTest::test_FileName()
{
...
void CHPQuantificationDetectionDataTest::test_ArrayType()
{
	CHPQuantificationDetectionData data;
...
void CHPQuantificationDetectionDataTest::test_AlgName()
{
	CHPQuantificationDetectionData data;
...
void CHPQuantificationDetectionDataTest::test_AlgVersion()
{
	CHPQuantificationDetectionData data;
...
void CHPQuantificationDetectionDataTest::test_AlgParams()
{
...
void CHPQuantificationDetectionDataTest::test_SumParams()
{
	ParameterNameValueTypeList params;
	ParameterNameValueType param;
	CHPQuantificationDetectionData data;
