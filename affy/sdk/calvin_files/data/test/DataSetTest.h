...
#ifndef __DATASETTEST_H_
#define __DATASETTEST_H_

#include <cppunit/extensions/HelperMacros.h>
#include "GenericData.h"

/*
 * This tests the basic functions of the DataSet class.
 ...
 */
class DataSetTest : public CPPUNIT_NS::TestFixture  
{
...
// Remaing tests to write:
// Header
// UnmapFile
// all the untested GetData

// Tested indirectly by current tests:
// MapData - is this testing complete enough?
// CheckRowColumnAndType - tested that expected exceptions are thrown here
// FilePosition - getting the correct value implies that this is working
// UpdateColumnByteOffsets - getting the correct value implies that this is working

#endif // __DATASETTEST_H_
