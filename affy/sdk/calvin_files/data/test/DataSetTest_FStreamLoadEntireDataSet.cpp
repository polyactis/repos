...
#include "DataSetTest_FStreamLoadEntireDataSet.h"
...
CPPUNIT_TEST_SUITE_REGISTRATION( DataSetTest_FStreamLoadEntireDataSet );

DataSetTest_FStreamLoadEntireDataSet::DataSetTest_FStreamLoadEntireDataSet()
{
	data = 0;
	dataPlane = 0;
}
...
void DataSetTest_FStreamLoadEntireDataSet::setUp()
{
	...
	dataPlane = new DataSet(data->Header().GetFilename(), *dphBegin, ifs, true);
}

void DataSetTest_FStreamLoadEntireDataSet::tearDown()
{
	ifs.close();
	if (dataPlane)
		dataPlane->Delete();
...
void DataSetTest_FStreamLoadEntireDataSet::testCreation()
{
...
void DataSetTest_FStreamLoadEntireDataSet::testmethod_Delete()
{
	DataSetHeader header;
	DataSet* dc = new DataSet(TEST_DATA_DAT_FILE, header,ifs);
	CPPUNIT_ASSERT(dc != 0);
...
void DataSetTest_FStreamLoadEntireDataSet::testmethod_Open()
{
	CPPUNIT_ASSERT(dataPlane->Open() == true);
	// TBD: How to assert that the DataGroup is open?
}

void DataSetTest_FStreamLoadEntireDataSet::testmethod_Close()
{
	CPPUNIT_ASSERT(dataPlane->Open() == true);
...
void DataSetTest_FStreamLoadEntireDataSet::testproperty_BytesPerRow()
{
	CPPUNIT_ASSERT(dataPlane->Open() == true);
...
void DataSetTest_FStreamLoadEntireDataSet::testproperty_Rows()
{
	CPPUNIT_ASSERT(dataPlane->Open() == true);
...
void DataSetTest_FStreamLoadEntireDataSet::testproperty_Cols()
{
	CPPUNIT_ASSERT(dataPlane->Open() == true);
...
void DataSetTest_FStreamLoadEntireDataSet::testproperty_Header()
{
...
void DataSetTest_FStreamLoadEntireDataSet::testmethod_ReadUInt16_Single()
{
	CPPUNIT_ASSERT(dataPlane->Open() == true);
...
void DataSetTest_FStreamLoadEntireDataSet::testmethod_ReadUInt16_Vector()
{
	CPPUNIT_ASSERT(dataPlane->Open() == true);
...
void DataSetTest_FStreamLoadEntireDataSet::testmethod_ReadUInt16_Vector_TooManyRows()
{
	CPPUNIT_ASSERT(dataPlane->Open() == true);
...
void DataSetTest_FStreamLoadEntireDataSet::testmethod_ReadUInt16_Vector_InChunks()
{
	CPPUNIT_ASSERT(dataPlane->Open() == true);
...
void DataSetTest_FStreamLoadEntireDataSet::testmethod_ReadUInt16_Raw()
{
	CPPUNIT_ASSERT(dataPlane->Open() == true);
...
void DataSetTest_FStreamLoadEntireDataSet::testmethod_ReadUInt16_Raw_TooManyRows()
{
	CPPUNIT_ASSERT(dataPlane->Open() == true);
...
void DataSetTest_FStreamLoadEntireDataSet::testmethod_ReadUInt16_Raw_InChunks()
{
	CPPUNIT_ASSERT(dataPlane->Open() == true);
...
void DataSetTest_FStreamLoadEntireDataSet::testmethod_CheckRowColumnAndType_DataSetNotOpenException()
{
...
void DataSetTest_FStreamLoadEntireDataSet::testmethod_CheckRowColumnAndType_ColumnOutOfBoundsException()
{
	CPPUNIT_ASSERT(dataPlane->Open() == true);
...
void DataSetTest_FStreamLoadEntireDataSet::testmethod_CheckRowColumnAndType_RowOutofBoundsException()
{
	CPPUNIT_ASSERT(dataPlane->Open() == true);
...
void DataSetTest_FStreamLoadEntireDataSet::testmethod_CheckRowColumnAndType_UnexpectedColumnTypeException()
{
	CPPUNIT_ASSERT(dataPlane->Open() == true);
...
void DataSetTest_FStreamLoadEntireDataSet::testmethod_ReadUInt16_Single_DataSetNotOpenException()
{ 
	u_int16_t value;
	CPPUNIT_ASSERT_THROW(dataPlane->GetData(0, 0, value), affymetrix_calvin_exceptions::DataSetNotOpenException);
}

void DataSetTest_FStreamLoadEntireDataSet::testmethod_ReadUInt16_Vector_DataSetNotOpenException()
{ 
	Uint16Vector values;
	CPPUNIT_ASSERT_THROW(dataPlane->GetData(0, 0, 1, values), affymetrix_calvin_exceptions::DataSetNotOpenException);
}

void DataSetTest_FStreamLoadEntireDataSet::testmethod_ReadUInt16_Raw_DataSetNotOpenException()
{ 
