...
#ifndef __DATASETTEST_FSTREAMLOADENTIREDATASET_H_
#define __DATASETTEST_FSTREAMLOADENTIREDATASET_H_
 ...
 * The fixture creates DataSets that read all DataSet data into a memory buffer.
 ...
 */
class DataSetTest_FStreamLoadEntireDataSet : public CPPUNIT_NS::TestFixture  
{
	CPPUNIT_TEST_SUITE(DataSetTest_FStreamLoadEntireDataSet);
...
public:
	DataSetTest_FStreamLoadEntireDataSet();
	~DataSetTest_FStreamLoadEntireDataSet();
...
#endif // __DATASETTEST_FSTREAMLOADENTIREDATASET_H_
