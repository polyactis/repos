...
#ifndef __DATAGROUPTEST_FSTREAM_H_
#define __DATAGROUPTEST_FSTREAM_H_
 ...
 */
class DataGroupTest_FStream : public CPPUNIT_NS::TestFixture  
{
	CPPUNIT_TEST_SUITE( DataGroupTest_FStream );
...
#endif // __DATAGROUPTEST_FSTREAM_H_
