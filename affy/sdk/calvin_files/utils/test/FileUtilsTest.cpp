...
void FileUtilsTest::testCreation()
{
	FileUtils utils;
	CPPUNIT_ASSERT( 1 );
}
...
void FileUtilsTest::testmethod_ListFiles()
{
    ...
    {
        file = *it;
        if (file == "../data/file1.a")
            filesarray[0] = file;

        else if (file == "../data/file2.a")
            filesarray[1] = file;

        else if (file == "../data/file3.a")
            filesarray[2] = file;
    }
	CPPUNIT_ASSERT( filesarray[0] == "../data/file1.a" );
	CPPUNIT_ASSERT( filesarray[1] == "../data/file2.a" );
	CPPUNIT_ASSERT( filesarray[2] == "../data/file3.a" );
    ...
    {
        file = *it;
        if (file == "../data/file1.b")
            filesarray[0] = file;

        else if (file == "../data/file2.b")
            filesarray[1] = file;
    }
	CPPUNIT_ASSERT( filesarray[0] == "../data/file1.b" );
	CPPUNIT_ASSERT( filesarray[1] == "../data/file2.b" );
	...
	it = files.begin();
	file = *it;
	CPPUNIT_ASSERT( file == "../data/file1.c" );
	++it;
