...
const string EXP_XDA_FILE		= "../../../TestDataFiles/CDF/Test3-xda.CDF";
const string EXP_ASCII_FILE		= "../../../TestDataFiles/CDF/Test3-ascii.CDF";
const string NO_FILE			= "../../../TestDataFiles/CDF/NoFile.CDF";
const string MAP_XDA_FILE		= "../../../TestDataFiles/CDF/Mapping10K_Xba131-xda.CDF";
const string MAP_ASCII_FILE		= "../../../TestDataFiles/CDF/Mapping10K_Xba131-ascii.CDF";
