...
STDMETHODIMP CProbeSetMultiDataGenotypeDataCOM::InterfaceSupportsErrorInfo(REFIID riid)
{
	static const IID* arr[] = 
	{
		&IID_IProbeSetMultiDataGenotypeData
	};
...
STDMETHODIMP CProbeSetMultiDataGenotypeDataCOM::get_name(BSTR* pVal)
{
	*pVal = COMStringUtils::ConvertString(data.name);
	return S_OK;
}

STDMETHODIMP CProbeSetMultiDataGenotypeDataCOM::get_call(int * pVal)
{
	*pVal = data.call;
	return S_OK;
}

STDMETHODIMP CProbeSetMultiDataGenotypeDataCOM::get_confidence(float* pVal)
{
	*pVal = data.confidence;
    return S_OK;
}

STDMETHODIMP CProbeSetMultiDataGenotypeDataCOM::get_metricCount(int *pVal)
{
    *pVal = (int)data.metrics.size();
    return S_OK;
}

STDMETHODIMP CProbeSetMultiDataGenotypeDataCOM::GetMetricName(int index, BSTR* pVal)
{
...
STDMETHODIMP CProbeSetMultiDataGenotypeDataCOM::GetMetric(int index, VARIANT* pVal)
{
    ParameterNameValueType &nv = data.metrics[index];
